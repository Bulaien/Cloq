...
const fünfMin = document.querySelectorAll(".fünf-min")
...
const fünfUhr = document.querySelectorAll(".fünfuhr")
...
if (hours === 1 || hours === 13 ){
    ...
    for (let i=0; i<einUhr.length ; i++){
        ...
        for (let k=0; k<zwölfUhr.length ; k++){
            zwölfUhr[k].style.color ="black"}
    ...
    for (let i=0; i<fünfUhr.length ; i++){

        fünfUhr[i].style.color ="red"
        }
    ...
    for (let i=0; i< sechsUhr.length ; i++){
        ...
        for (let k=0; k<fünfUhr.length ; k++){

            fünfUhr[k].style.color ="black"}
    ...
    for (let i=0; i<zwölfUhr.length ; i++){

        zwölfUhr[i].style.color ="red"
        }
...
if ( min < 05) {
    for (let i=0; i<Uhr.length ; i++){

        Uhr[i].style.color ="red"}
    
    for (let k=0; k<fünfMin.length ; k++){
            
        fünfMin[k].style.color ="black"}
    for (let j =0; j<vor.length;j++){
    vor[j].style.color ="black"}
}
 else if (min >= 5 && min < 10) {
    for (let i=0; i<fünfMin.length ; i++){

        fünfMin[i].style.color ="red"}
    ...
    for (let j =0; j<vor.length;j++){
        ...
        for (let k =0; k<halb.length;k++){
            halb[k].style.color ="red"
    }
    for (let l=0; l<zwanzigMin.length ; l++){

        zwanzigMin[l].style.color ="black"}
